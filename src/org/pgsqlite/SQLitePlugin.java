...
public class SQLitePlugin extends CordovaPlugin
{
	...
	private boolean deleteDatabase(String dbname)
	{
		...
		try {
			...
			status = this.cordova.getActivity().getApplicationContext().deleteDatabase(dbname+".db");

			/* Method mDeleteDatabase = SQLiteDatabase.class.getMethod("deleteDatabase", File.class);
            status = (Boolean) mDeleteDatabase.invoke(null, dbfile); */ 
